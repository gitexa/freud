...
from utils.text_body import TextBody
...
class Parser:
    ...
    def _read_docx_into_frame(self, path2file: str, couple_id_pat: str = re.compile(
        ...
        paragraph_w_speakers_separated = [_split_speaker_text(
            p) for p in paragraph_w_speakers_wo_legend]  
        ...
        group_tel = couple_metadata["Gruppe_TEL"].iloc[0] 
        is_depressed_group = bool(group_tel-1)  
        ...
        self.frame = pd.concat([self.frame, new_df], axis=0, join='outer')
